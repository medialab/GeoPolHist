...
copy("GeoPolHist_entities_status_over_time.csv", "../public/data/")
# copy full data
...
with open('GeoPolHist_status.csv', 'r', encoding='utf8') as fcsv, open('../public/data/GPH_status.json', 'w', encoding='utf8') as fjson:
    ...
    json.dump({s['GPH_status']: {"GPH_status": s['GPH_status'], "slug": s['slug'],
                                 "priority": s['priority_order']} for s in status}, fjson, indent=2, ensure_ascii=False)
# copy Sankey data
